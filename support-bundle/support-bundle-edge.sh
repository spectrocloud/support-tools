...
SYSTEM_NAMESPACES=(capi-webhook-system cert-manager harbor kube-system kube-public longhorn-system os-patch palette-system reach-system spectro-system system-upgrade)
